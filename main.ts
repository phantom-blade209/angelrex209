...
scene.setBackgroundImage(img`
    ...
    ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
    `)
game.showLongText("Oh is just me in space", DialogLayout.Bottom)
pause(1000)
game.showLongText("it kinda feels nice u know..", DialogLayout.Bottom)
pause(1000)
game.showLongText("just the only one. Piece and quiet", DialogLayout.Bottom)
pause(1000)
game.showLongText("...", DialogLayout.Bottom)
pause(2000)
game.showLongText("yeah I am tired of this now", DialogLayout.Bottom)
pause(2000)
story.showPlayerChoices("Return to Earth?", "Stay in space?")
if (story.checkLastAnswer("Return to Earth?")) {
    ...
    pause(800)
    game.showLongText("home sweet home", DialogLayout.Bottom)
} else if (story.checkLastAnswer("Stay in space?")) {
    game.showLongText("on second thought maybe I will stay here. It will maybe be fun", DialogLayout.Bottom)
